...
export function ProjectEdit() {
  ...
  useEffect(() => {
    if (project) {
      reset({
        ...
        expert_tier: project.expert_tier,
  ...
  const selectedTier = watch('expert_tier') || project?.expert_tier
  const selectedDepartment = watch('department_id') || project?.department_id
  const selectedStatus = watch('status') || project?.status
