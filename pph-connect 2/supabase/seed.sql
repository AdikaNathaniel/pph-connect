...
VALUES
  -- John Doe stats (assigned to VA-ENG-2024)
  ('91111111-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', 'd1111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '7 days', 145, 38, 950.00, NOW(), NULL),
  ('91111112-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', 'd1111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '14 days', 138, 40, 1000.00, NOW(), NULL),
  ('91111113-1111-1111-1111-111111111111', 'b1111111-1111-1111-1111-111111111111', 'c1111111-1111-1111-1111-111111111111', 'd1111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '21 days', 142, 39, 975.00, NOW(), NULL),

  -- Jane Smith stats (assigned to VA-ENG-2024)
  ('92222221-2222-2222-2222-222222222222', 'b2222222-2222-2222-2222-222222222222', 'c2222221-2222-2222-2222-222222222222', 'd1111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '7 days', 180, 40, 1000.00, NOW(), NULL),
  ('92222222-2222-2222-2222-222222222222', 'b2222222-2222-2222-2222-222222222222', 'c2222221-2222-2222-2222-222222222222', 'd1111111-1111-1111-1111-111111111111', CURRENT_DATE - INTERVAL '14 days', 175, 40, 1000.00, NOW(), NULL),

  -- Carlos Garcia stats (assigned to AUD-SPA-2024)
  ('93333331-3333-3333-3333-333333333333', 'b3333333-3333-3333-3333-333333333333', 'c3333331-3333-3333-3333-333333333333', 'd3333333-3333-3333-3333-333333333333', CURRENT_DATE - INTERVAL '7 days', 125, 35, 875.00, NOW(), NULL),
  ('93333332-3333-3333-3333-333333333333', 'b3333333-3333-3333-3333-333333333333', 'c3333331-3333-3333-3333-333333333333', 'd3333333-3333-3333-3333-333333333333', CURRENT_DATE - INTERVAL '14 days', 130, 36, 900.00, NOW(), NULL),

  -- Priya Patel stats (assigned to NLP-SENT-2024)
  ('94444441-4444-4444-4444-444444444444', 'b4444444-4444-4444-4444-444444444444', 'c4444441-4444-4444-4444-444444444444', 'd4444444-4444-4444-4444-444444444444', CURRENT_DATE - INTERVAL '7 days', 165, 40, 1000.00, NOW(), NULL),

  -- Li Wei stats (assigned to MED-IMG-2024)
  ('96666661-6666-6666-6666-666666666666', 'b6666666-6666-6666-6666-666666666666', 'c6666661-6666-6666-6666-666666666666', 'd2222222-2222-2222-2222-222222222222', CURRENT_DATE - INTERVAL '7 days', 95, 38, 950.00, NOW(), NULL),
  ('96666662-6666-6666-6666-666666666666', 'b6666666-6666-6666-6666-666666666666', 'c6666661-6666-6666-6666-666666666666', 'd2222222-2222-2222-2222-222222222222', CURRENT_DATE - INTERVAL '14 days', 92, 38, 950.00, NOW(), NULL),

  -- Sophie Mueller stats (assigned to MED-IMG-2024)
  ('97777771-7777-7777-7777-777777777777', 'b7777777-7777-7777-7777-777777777777', 'c7777771-7777-7777-7777-777777777777', 'd2222222-2222-2222-2222-222222222222', CURRENT_DATE - INTERVAL '7 days', 88, 30, 750.00, NOW(), NULL)
ON CONFLICT (id) DO UPDATE SET
