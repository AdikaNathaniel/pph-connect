-- Fix the worker_daily_activity view by dropping and recreating it
-- This resolves the column name conflict error

DROP VIEW IF EXISTS public.worker_daily_activity;
