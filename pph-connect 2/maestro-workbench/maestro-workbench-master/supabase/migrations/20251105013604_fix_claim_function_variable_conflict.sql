-- Migration: Fix ambiguous 'id' with #variable_conflict directive
-- Created: 2025-11-05
-- Purpose: Resolve persistent ambiguous column error caused by RETURNS TABLE parameters
--          shadowing column names throughout the function
--
-- Root Cause: RETURNS TABLE("id" uuid, "project_id" uuid, ...) creates output parameters
--             that shadow column names in all queries, even simple SELECTs
--
-- Fix: Add #variable_conflict use_column directive to prefer column names over variables
-- ============================================================================
